...
namespace scp_294.Items.DrinkFeatures
{
    public class SpecialEffects
    {
        ...
        /// <summary>
        /// Gets or sets the max heal amount.
        /// </summary>
        [Description("Whether or not the player max HP.")]
        public float MaxHealAmount { get; set; } = 100f;
        /// <summary>
        ...
        public void ApplySpecialEffects(Player player)
        {
            ...
            if (MaxHealAmount < 100) 
            {
                player.MaxHealth = MaxHealAmount;
